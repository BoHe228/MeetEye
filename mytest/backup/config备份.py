...
def parse_args():
    ...
    parser.add_argument('--appearance-thresh', type=float, default=0.35,
                        help='BoT-SORT外观特征匹配阈值（余弦距离，第一阶段+IoU门控，越小越严格，建议 0.35-0.45）')
    parser.add_argument('--reid-lost-thresh', type=float, default=0.2,
                        help='纯ReID恢复Lost轨迹的阈值（第三阶段，无IoU门控，须比appearance-thresh更严格，建议 0.20-0.30）')
